    ...
    CORE_TRAIN_KEYS = frozenset(
        {
            ...
            "reference_smoothness_weighted_loss",
            "reference_endpoint_error",
            "reference_step_size",
            "action_l2_loss",
            "motor_balance_loss",
            "action_delta_loss",
    ...
    LATENT_TRAIN_KEYS = frozenset(
        {
            ...
            "async_cache_age_steps",
            "async_cache_age_seconds",
            "async_cache_age_ratio",
            "async_cache_valid",
            "async_reference_index",
            "async_high_level_refreshed",
            "async_safe_fallback",
            "async_degraded_fallback",
            "reference_grad_norm_supervised",
            "reference_grad_norm_actor",
        }
    )
    CONFIG_KEYS = frozenset(
        {
            ...
            "actor_rl_start_step",
            "structured_motor_actor",
            "lower_action_history_steps",
            "reference_loss_weight",
            "high_level_actor_grad_scale",
            "action_l2_weight",
            "motor_balance_weight",
            "action_delta_weight",
            "normalize_actor_q",
